...
# from state_options import next_state_options
...
def build_user_message(base_user_prompt: str,
    ...
    '''
    user_prompt = base_user_prompt.format(examples=examples, current_state=current_state, transmissions=radio_tracks, next_state_options=next_state_options)
    return user_prompt